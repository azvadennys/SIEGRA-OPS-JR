@extends('layouts.app', ['title' => 'Edit Data Kecelakaan'])
            ...
            <div class="col-xl-8 order-xl-1 mb-3">
                ...
                <div class="card z-index-0 fadeIn3 fadeInBottom mb-5">
                    <div class="card-header card-header-primary ">
                        ...
                        <h4 class="card-title text-white font-weight-bolder text-center">Edit Data Kecelakaan</h4>
                    ...
                    <div class="card-body">
                        ...
                        @endif
                        <form method="post" action="{{ route('kecelakaan.update', $data->id) }}" autocomplete="off">
                            @csrf
                            ...
                            <div class="row">
                                <div class="col-md-4 my-2">
                                    ...
                                    <input class="form-control" list="listBerkas" id="Berkas" name="asal_berkas"
                                        value="{{ old('asal_berkas', $data->asal_berkas) }}" required>
                                ...
                                <div class="col-md-4 my-2">
                                    ...
                                    <input class="form-control" list="listSamsat" id="samsat" name="samsat"
                                        value="{{ old('samsat', $data->samsat) }}" required>
                                ...
                                <div class="col-md-6 my-2">
                                    ...
                                    <input class="form-control" id="nama_korban" type="text" name="nama_korban"
                                        value="{{ old('nama_korban', $data->nama_korban) }}" required>
                                </div>
                                <div class="col-md-6 my-2">
                                ...
                                <div class="col-md-4 my-2">
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control" name="alamat_tkp" id="alamat_tkp" cols="30" rows="2" required>{{ old('alamat_tkp', $data->alamat_tkp->alamat) }}</textarea>
                                ...
                                <div class="col-md-4 my-2">
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control" name="alamat_korban" id="alamat_korban" cols="30" rows="2" required>{{ old('alamat_korban', $data->alamat_korban->alamat) }}</textarea>
                                ...
                                <div class="col-md-4 my-2">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" type="text" id="uraian_singkat"
                                            name="uraian_singkat"
                                            value="{{ old('uraian_singkat', $data->uraian_singkat) }}" required>
                                    </div>
                                </div>
                                <div class="col-md-4 my-2">
                                    <div class="form-group">
                                ...
                                <div class="col-md-4 my-2">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" type="text" id="cidera" name="cidera"
                                            value="{{ old('cidera', $data->cidera) }}" required>
                                    </div>
                                </div>
                                <div class="col-md-4 my-2">
                                    <div class="form-group">
                            ...
                            <div class="col-md-12 ">
                                ...
                                <a href="{{ route('kecelakaan') }}" class="btn btn-info text-white">Kembali</a>
                            </div>
