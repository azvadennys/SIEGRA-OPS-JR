@extends('layouts.app', ['title' => 'Tambah Data Kendaraan'])
                ...
                <div class="col-xl-8 order-xl-1 mb-3">
                    ...
                    <div class="card z-index-0 fadeIn3 fadeInBottom mb-5">
                        <div class="card-header card-header-primary ">
                            <h4 class="text-white font-weight-bolder text-center mt-2 mb-0">Tambah Data Kendaraan</h4>
                        ...
                        <div class="card-body">
                            ...
                            @endif
                            <form method="post" action="{{ route('kendaraan.store') }}" autocomplete="off">
                                @csrf
                                ...
                                <div class="row">
                                    <div class="col-md-6 my-2">
                                        ...
                                        <input class="form-control" id="nopol" type="text" name="nopol"
                                            maxlength="10" value="{{ old('nopol') }}" required>
                                        @error('nopol')
                                    ...
                                    <div class="col-md-6 my-2">
                                        ...
                                        <input class="form-control" list="listJenis" id="jenis" name="jenis_kendaraan"
                                            maxlength="4" value="{{ old('jenis_kendaraan') }}" required>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control" name="alamat" id="alamat" cols="30" rows="5" required>{{ old('alamat') }}</textarea>
                                            @error('alamat')
                                                <p class="text-danger text-xs pt-1"> {{ $message }} </p>
                                            @enderror
                                        </div>
