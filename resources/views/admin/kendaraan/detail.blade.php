@extends('layouts.app', ['title' => 'Detail Data Kendaraan'])
                ...
                <div class="col-xl-8 order-xl-1 mb-3">
                    ...
                    <div class="card z-index-0 fadeIn3 fadeInBottom mb-5">
                        <div class="card-header card-header-primary ">
                            ...
                            <h4 class="card-title text-white font-weight-bolder text-center">Detail Data Kendaraan</h4>
                        ...
                        <div class="card-body">
                            ...
                            <form method="post" action="{{ route('kendaraan.update', $data->nopol) }}" autocomplete="off">
                                ...
                                <div class="row">
                                    <div class="col-md-6 my-2">
                                        ...
                                        <input class="form-control" id="nopol" type="text" name="nopol"
                                            maxlength="10" value="{{ old('nopol', $data->nopol) }}" required readonly>
                                        @error('nopol')
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" id="Nama" type="text" name="nama"
                                                value="{{ old('nama', $data->nama) }}" required readonly>
                                            @error('nama')
                                                <p class="text-danger text-xs pt-1"> {{ $message }} </p>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control" name="alamat" id="alamat" cols="30" rows="5" required readonly>{{ old('alamat', $data->alamat) }}</textarea>
                                            @error('alamat')
                                                <p class="text-danger text-xs pt-1"> {{ $message }} </p>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="col-md-6 my-2">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" id="tgl_pkb" type="date" name="tgl_pkb"
                                                value="{{ old('tgl_pkb', $data->tgl_pkb) }}" required readonly>
                                            @error('tgl_pkb')
                                                <p class="text-danger text-xs pt-1"> {{ $message }} </p>
                                            @enderror
                                        </div>
                                ...
                                <div class="col-12 text-center mt-3">
                                    <a href="{{ route('kendaraan') }}" class="btn btn-info text-white">Kembali</a>
                                </div>
