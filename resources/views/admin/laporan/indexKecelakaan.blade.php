@extends('layouts.app', ['class' => 'g-sidenav-show bg-gray-100', 'title' => 'Cetak Tingkat Kecelakaan'])
                    ...
                    <div class="card-header border-0">
                        <div class="row">
                            <div class="col-lg-6 col-7">
                                <h3 class="mb-0">Cetak Tingkat Kecelakaan</h3>
                            </div>
                    ...
                    <div class="card-body p-0">
                        <div class="row  justify-content-center">
                            ...
                            <div class="col-6 mx-4 ">
                                <form action="{{ route('laporan.kecelakaan.cetak') }}" method="post" target="_blank">
                                    @csrf

                                    <div class="form-group">
                                        <label for="region">Pilih Berdasarkan :</label>
